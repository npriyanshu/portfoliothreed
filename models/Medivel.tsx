...
export function MedievalModel(props:ModelProps) {
  const groupRef = useRef()
  const { nodes, materials, animations } = useGLTF('/assets3d/free_low_poly_game_assets.glb')
...
useGLTF.preload('/assets3d/free_low_poly_game_assets.glb')
